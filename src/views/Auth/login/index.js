                ...
                <form className="flex flex-col justify-center items-center" action="/onboarding">
                    <div className="w-[330px] mt-[30px]">
                        ...
                        <div className="mt-[26px] ml-[22px] flex items-center border-b border-[#000] border-light py-2 mr-[22px] ">
                            ...
                            <input className="appearance-none ml-[5px] mr-[10px] bg-transparent border-none text-gray-700 focus:outline-none" required type="email" aria-label="Email" placeholder=""></input>
                        </div>
                        <div className="mt-[26px] ml-[22px] flex items-center border-b border-[#000] border-light py-2 mr-[22px] ">
                            <p className="text-[18px] color-[#000] font-normal text-left">Password</p>
                            <input className="appearance-none ml-[5px] mr-[10px] bg-transparent border-none text-gray-700 focus:outline-none" required type="password" aria-label="Password" placeholder=""></input>
                        </div>                    
                        <div className="mt-[61px] flex items-center justify-center">
                            <button type="submit" className="flex-shrink-0 bg-[#3f85e3] hover:bg-teal-700 border-[#3f85e3] hover:border-teal-700 h-[35px] w-[131px] text-sm border-4 text-white py-1 px-2 rounded">
                                Sign In
                            </button>
                        </div>
                    </div>
            ...
            <div className="sm:hidden block relative flex-col flex mt-0 justify-center items-center">
                <form className="flex flex-col justify-center items-center" action="/onboarding">
                    ...
                    <div className="mt-[24px] ml-[22px] w-[287px] flex items-center border-b border-[#5B59D6] border-light py-2 mr-[22px] ">
                        ...
                        <input className="appearance-none mr-[10px] bg-transparent border-none text-gray-700 focus:outline-none mr-[22px]" type="email" name="email" autoComplete="email" required aria-label="FullName" placeholder="Email Address"></input>
                    </div>
                    <div className="mt-[24px] ml-[22px] w-[287px] flex items-center border-b border-[#5B59D6] border-light py-2 mr-[22px] ">
                        <figure className="">
                            <img src={Passwordicon} className=" text-[18px] color-[#000] font-normal focus:fill-[#5B59D6]" alt=""></img>    
                        </figure>&nbsp;&nbsp;
                        <input className="appearance-none mr-[10px] bg-transparent border-none text-gray-700 focus:outline-none mr-[22px]" type="password" name="password" autoComplete="password" required placeholder="Password"></input>
                    </div>                
                    <div className="mt-[201px] flex items-center justify-center">                        
                        <button className="flex-shrink-0 bg-[#3f85e3] hover:bg-teal-700 border-[#3f85e3] hover:border-teal-700 h-[52px] w-[327px] text-[16px] font-medium border-4 text-white py-1 px-2 rounded rounded-xl" type="submit">
                               Log In
                        </button>                        
                    </div>
                </form>    
