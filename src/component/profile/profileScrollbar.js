...
const ProfileScrollbar = () => {
  ...
  const [tabsList, setTabsList] = useState(
    [
      { Title: 'Speaks',icon: FiMessageSquare , id: 'breaking_id', data_hs_tab: "#pills-with-brand-color-1", aria_controls: "pills-with-brand-color-1"},
  ...
  return (
    <div className="sm:mb-8 mb-[80px]">
      <nav className="flex space-x-2 rounded-lg overflow-x-auto bg-[#373C40] sm:px-2 px-0 sm:py-2 py-0 border border-opacity-40 border-[#8D969D] border-bold sm:w-full w-11/12 mx-3 sm:mx-0 border-1" aria-label="Tabs" role="tablist">
