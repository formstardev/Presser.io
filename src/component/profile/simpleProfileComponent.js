            ...
            <div className="sm:w-full flex flex-col items-center justify-center">
                ...
                <div className="mt-2 w-full flex justify-between mx-2 ">
                    <div className="flex ">
                        ...
                        <div className="ml-3">
                            <p className="text-white font-bold sm:text-[24px] text-[20px]">Matthew Smith</p>
                    ...
                    <div className="flex flex-col flex-grow">
                        <div className="flex justify-between mx-7">
                            <div className="flex flex-col justify-center items-center">
                                <p className="text-white md:text-[20px] text-[16px] font-medium">56</p>
                                <p className="text-white md:text-[12px] text-[10px] font-light">Speaks</p>
                            </div>
                            <div className="flex flex-col justify-center items-center">
                                <p className="text-white md:text-[20px] text-[16px] font-medium">1,136</p>
                                <p className="text-white md:text-[12px] text-[10px] font-light">Followers</p>
                            </div>
                            <div className="flex flex-col justify-center items-center">
                                <p className="text-white md:text-[20px] text-[16px] font-medium">123</p>
                                <p className="text-white md:text-[12px] text-[10px] font-light">Following</p>
                            </div>
                        </div>
                ...
                <p className="text-white my-3 md:text-[14px] text-[12px] flex justify-center items-center">
